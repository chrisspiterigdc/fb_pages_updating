...
def print_daily_offer_task(date_str: str) -> None:
    ...
    print()
    print("INSTRUCTIONS:")
    print("1. Use WebFetch on https://www.freebets.com/ to read the LIVE homepage.")
    print("   The #1 offer is the top-ranked card (marked with a '1' badge).")
    print("   Read that card and its small print directly. Identify:")
    print("   bookmaker name, offer headline, promo code, and key terms")
    print("   (min deposit, min bet, min odds as fractional, free bet breakdown, expiry, exclusions).")
    print("   IMPORTANT: Use ONLY the bookmaker and terms shown on the freebets.com #1 card.")
    print("   Do NOT substitute a different bookmaker's promo from comparison sites or brand pages —")
    print("   those routinely surface a different offer than the one freebets.com ranks first.")
    print()
    print("2. Use WebSearch to find today's major sports events from wheresthematch.com.")
    print("   Search query: 'site:wheresthematch.com sport on TV today [date]'")
    print("   Also try: 'wheresthematch.com [date] sport UK TV today'")
    print("   Pick 1-2 events most relevant to the bookmaker's offer and UK audience.")
    print("   Prioritise: Royal Ascot / major racing, World Cup fixtures, Premier League, England cricket, major tennis.")
    print()
    ...
    print()
    print("NOTE: WebFetch is allowed ONLY for freebets.com (to read the live #1 card in step 1).")
    print("For all other research, including sports events in step 2, use WebSearch.")
    print()
    print("STYLE GUIDE:")
