...
def print_daily_offer_task(date_str: str) -> None:
    ...
    print("- Fourth/fifth section: today's sports context as an HTML unordered list (<ul>). Each event is a <li> with the event name, time, and channel.")
    print("  Example format:")
    print("  <ul>")
    print("  <li>Queen Anne Stakes, Royal Ascot — 2:30pm, ITV1</li>")
    print("  <li>France v Senegal — 8pm, BBC One</li>")
    print("  </ul>")
